...
Public Function SumaCondicionalAvanzada( _
    ...
    Dim esOperario As Boolean, colIdxInMN As Long, rolOperario As Long, rolOperarioBase As Long
    ...
    For i = 1 To nRows
        ...
        If esOperario Then
            ...
            roleShareOp = OperarioRoleShare(rolOperarioBase, rolOperario, tokensFila, wRole)
...
Private Function OperarioRoleShare(ByVal rolBase As Long, ByVal rolOperario As Long, ByRef tokens As Variant, ByRef wRole() As Double) As Double
    Dim present(1 To 3) As Boolean
    Dim k As Long, rolesCount As Long, missRole As Double

    If rolBase < 1 Or rolBase > 3 Then rolBase = 1
    If rolOperario < 1 Or rolOperario > 3 Then rolOperario = rolBase
    ...
    If rolesCount <= 1 Then
        OperarioRoleShare = 1#
    Else
        OperarioRoleShare = wRole(rolBase) + missRole / rolesCount
    End If
End Function
...
Public Function SumaCondicionalOperario( _
    ...
    Dim i As Long
    Dim totalOp As Double
    Dim colIdxInMN As Long, rolCrit As Long, rolOperarioBase As Long
    Dim plainSum() As Double, plainCount() As Long, vSum() As Double, hSum() As Double
    ...
    For i = 1 To nRows
        ...
        Dim roleShareOp As Double
        roleShareOp = OperarioRoleShare(rolOperarioBase, rolCrit, tokensFila, wRole)
